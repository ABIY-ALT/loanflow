...
import { mockUsers, mockWorkflowDefinitions } from '@/lib/mock-data';
    ...
    async function fetchReviewLoans() {
      ...
      try {
        ...
        if (result.error) {
          ...
          const filteredLoans = result.loans.filter(loan => loan.isReadyForManagerReview && loan.assignedTo); // Must be assigned to a staff for review
