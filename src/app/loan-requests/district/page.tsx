...
import { addType2LoanRequest, checkCustomerForActiveLoans } from '@/services/loan-service-prisma';
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <div className="relative">
                        ...
                        <FormControl>
                          <Input placeholder="email@example.com (optional)" {...field} className={cn("pl-10", form.formState.errors.customerEmail && "border-destructive focus-visible:ring-destructive")} disabled={isSubmitting} />
                        </FormControl>
                      </div>
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <div className="relative">
                        ...
                        <FormControl>
                          <Input placeholder="e.g., 0912345678" {...field} className={cn("pl-10", form.formState.errors.customerPhone && "border-destructive focus-visible:ring-destructive")} disabled={isSubmitting} />
                        </FormControl>
                      </div>
                      <FormMessage />
                    </FormItem>
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <div className="relative">
                      ...
                      <FormControl>
                        <Textarea placeholder="Describe the purpose of the loan..." className={cn("resize-none pl-10", form.formState.errors.loanPurpose && "border-destructive focus-visible:ring-destructive")} {...field} disabled={isSubmitting} />
                      </FormControl>
                    </div>
