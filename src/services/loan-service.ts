...
export function convertTimestampsToISO(data: any, depth = 0, maxDepth = 15, seen?: Set<any>): any {
  ...
  if (Array.isArray(data)) {
    ...
    try {
      ...
      // console.warn(`[Service:convertTimestampsToISO] Error calling toDate on a Timestamp-like object at depth ${depth}. Constructor: ${data.constructor?.name}:`, e, 'Data:', data);
