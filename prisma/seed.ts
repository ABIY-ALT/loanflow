...
async function main() {
  ...
  const rolesToSeed = [
    ...
    { name: "Director", permissions: [PERMISSIONS.VIEW_DASHBOARD, PERMISSIONS.VIEW_EXECUTIVE_OVERVIEW, PERMISSIONS.VIEW_LOAN_PIPELINE, PERMISSIONS.VIEW_LOAN_DETAILS, PERMISSIONS.VIEW_CUSTOMERS, PERMISSIONS.VIEW_MANAGER_REVIEW_QUEUE, PERMISSIONS.PROMOTE_LOAN_STAGE, PERMISSIONS.RETURN_LOAN_FOR_REWORK] },
    { name: "Manager", permissions: [PERMISSIONS.VIEW_DASHBOARD, PERMISSIONS.VIEW_EXECUTIVE_OVERVIEW, PERMISSIONS.VIEW_LOAN_PIPELINE, PERMISSIONS.VIEW_LOAN_DETAILS, PERMISSIONS.VIEW_MANAGER_REVIEW_QUEUE, PERMISSIONS.PROMOTE_LOAN_STAGE, PERMISSIONS.ASSIGN_LOAN_TO_STAFF] },
    ...
    { name: "Manager, Property Valuation (Maker)", permissions: [PERMISSIONS.VIEW_DASHBOARD, PERMISSIONS.VIEW_LOAN_PIPELINE, PERMISSIONS.VIEW_LOAN_DETAILS, PERMISSIONS.VIEW_MANAGER_REVIEW_QUEUE, PERMISSIONS.VIEW_OWN_ASSIGNED_CASES, PERMISSIONS.ADD_LOAN_NOTES, PERMISSIONS.LOG_INFO_REQUEST, PERMISSIONS.RETURN_LOAN_FOR_REWORK, PERMISSIONS.ASSIGN_LOAN_TO_STAFF, PERMISSIONS.FLAG_URGENT_CASE, PERMISSIONS.MARK_STAGE_COMPLETE] },
    { name: "Manager, Property Valuation (Checker)", permissions: [PERMISSIONS.VIEW_DASHBOARD, PERMISSIONS.VIEW_LOAN_PIPELINE, PERMISSIONS.VIEW_LOAN_DETAILS, PERMISSIONS.VIEW_MANAGER_REVIEW_QUEUE, PERMISSIONS.VIEW_OWN_ASSIGNED_CASES, PERMISSIONS.ADD_LOAN_NOTES, PERMISSIONS.PROMOTE_LOAN_STAGE, PERMISSIONS.RETURN_LOAN_FOR_REWORK, PERMISSIONS.FLAG_URGENT_CASE] },
